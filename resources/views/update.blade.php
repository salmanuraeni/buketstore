...
<body>
    <nav class="navbar navbar-expand-sm navbar-dark" style="background-color: rgb(224, 167, 177)">
        <div class="container-fluid">
            <a href="#" class="navbar-brand">Fresh Flower</a>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card mt-5">
                    ...
                    <div class="card-body">
                        <form action="/dasboard/update/{{$produk->id}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group pt-2">
                                <label for="productName">Nama Produk</label>
                                <input type="text" name="name" class="form-control" id="productName" placeholder="Masukkan nama produk" value="{{$produk->name}}">
                            </div>
                            <div class="form-group pt-2">
